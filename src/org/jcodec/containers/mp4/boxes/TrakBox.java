...
public class TrakBox extends NodeBox {
    ...
    public EsdsBox findEsds() {
    	LeafBox b = NodeBox.findFirst(this, LeafBox.class, "esds");
        if (b == null) {
            b = NodeBox.findFirstPath(this, LeafBox.class, Box.path("mdia.minf.stbl.stsd.mp4a.esds"));
        }
        if (b == null)
            return null;
