...
public class Play {
	...
	public static void main(String[] args) {
		args = new String[]{"-mp4", "d:/Downloads/HocBAFr1djOAFrS4APCe7NpBBMk720.mp4"};
		try {
	...
	private static void decodeMP4(String in) throws Exception {
		...
		try {
			...
			List<Track> videos = movie.getTracks(VideoTrack.VideoCodec.AVC);
			if(videos.isEmpty()) {
				throw new Exception("movie does not contains any avc track");
			}
			
			VideoTrack vTrack = (VideoTrack) videos.get(0);
//			while(vTrack.hasMoreFrames()) {
//				Frame frame = vTrack.readNextFrame();
